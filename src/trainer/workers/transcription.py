...
from trainer.infrastructure.transcription import OpenAITranscriber
from trainer.services.transcription import claim, complete, fail
...
def process_one(transcriber=None) -> bool:
    ...
    try:
        ...
        storage = storage_from_env(runtime.AUDIO_DIR)
